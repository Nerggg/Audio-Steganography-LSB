        ...
        "/extract": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Steganography key (required only if file was encrypted during embedding)",
                        "name": "stego_key",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Desired filename for the extracted secret file (optional - will use original filename if not provided)",
                        "name": "output_filename",
                        "in": "formData"
                    }
                ],
